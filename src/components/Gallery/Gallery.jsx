...
import DataBase from "../../jumbo.db.json";
            ...
            <section className="body-font text-gray-500">
              <div className="container mx-auto px-5 py-24">
                <div className="mb-20 flex w-full flex-col text-center">
                  <h1 className="title-font mb-4 text-2xl font-medium text-gray-500 sm:text-3xl">
                    Welcome & Thank you for visiting
                  </h1>
                  <p className="mx-auto text-base leading-relaxed lg:w-2/3">
                    These projects are a selection of projects that have been
                    created or are in development. The projects include a
                    variety of web development projects, such as an e-commerce
                    store, a workflow management system, and a note taking app,
                    as well as a theme for Visual Studio Code. Each project
                    includes a brief description and information about the
                    technologies used.
                  </p>
                </div>
