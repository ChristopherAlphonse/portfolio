                ...
                <div className="container mx-auto px-5 py-24">
                  <div className="mb-20 flex w-full flex-col text-center">
                    ...
                    <p className="mx-auto text-base leading-relaxed lg:w-2/3">
                      ...
                      management system, and a note taking app, as well as a theme for Visual Studio Code. Each project
                      includes a brief description and information about the technologies used.
                    </p>
                  </div>
