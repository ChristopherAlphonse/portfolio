        ...
        <div id='pf1' className='pf w0 h0' data-page-no={1}>
          <div className='pc pc1 w0 h0'>
            ...
            <div className='t m0 x3 h3 y24 ff2 fs1 fc0 sc0 ls0 ws3'>
              Model-View
              <span className='_ _0' />
              -Controller<span className='_ _5'></span>(MVC)<span className='_ _5'> </span>|
              ...
              tegr
              <span className='_ _0' />
              ation/Continuous<span className='_'></span>Deliv
              <span className='_ _0' />
